...
<head>
    <meta charset="UTF-8">
    <title>View Bid Players | IPL Bidding Application</title>
...
<div class="container mt-5 mb-5">
    ...
    <h3 class="text-center mb-4">Bid Players</h3>

    <!-- TABLE -->
    <c:if test="${not empty bidPlayers}">
            ...
            <table class="table table-bordered table-striped text-center align-middle">
                <thead class="table-dark">
                    <tr>
                        <th>Player Name</th>
                        <th>Company Name</th>
                        <th>Bid Amount (Millions)</th>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach var="b" items="${bidPlayers}">
                        <tr>
                            <td>${b.playerName}</td>
                            <td>${b.companyName}</td>
                            <td>${b.bidAmount}</td>
    ...
    <!-- ERROR MESSAGE -->
    <c:if test="${empty bidPlayers && not empty error}">
