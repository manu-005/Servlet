...
<div class="container mt-5">
    ...
    <c:if test="${not empty success}">
        <div class="alert alert-success text-center fw-bold shadow">
            ${success}
            <div class="mt-3">
                <a href="SearchPlayer.jsp" class="btn btn-outline-success">
    ...
    <c:if test="${not empty error}">
        <div class="alert alert-danger text-center fw-bold shadow">
            ${error}
            <div class="mt-3">
                <a href="SearchPlayer.jsp" class="btn btn-outline-danger">
                    Back to Search Players
                </a>
            </div>
        </div>
