...
public class FoodServlet extends HttpServlet {
    ...
    public FoodServlet(){
        System.out.println("Food Servlet object created...");
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String iNm =  req.getParameter("iName");
        ...
        p.println("<title>Food Ordering Details</title>");
        ...
        p.println("<h2 class='text-center text-primary mb-4'> Food Ordering Details</h2>");
        p.println("<p><strong>Item Name:</strong> " + iNm + "</p>");
        p.println("<p><strong>Veg or  Non veg:</strong> " + type + "</p>");
        p.println("<p><strong>Quantity :</strong> " + quantity + "</p>");
        p.println("<p><strong>Payment Type:</strong> " + pay + "</p>");
        p.println("<p><strong>Delivery Instructions :</strong> " + inst + "</p>");
        p.println("<div class='text-center mt-4'>");
        p.println("<a href='food.html' class='btn btn-primary'>Go Back</a>");
        p.println("</div>");
        p.println("</div>");
        p.println("</div>");
